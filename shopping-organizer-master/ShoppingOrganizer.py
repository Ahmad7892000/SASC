...
class App(Tk):
    def __init__(self):
        ...
        self.bind('<Return>', self.getSearchResults)
        self.addComponents()
    ...
    def getSearchResults(self, event="hello"):
        ...
        file = open("D:/Final Year Project/GUI/shopping-organizer-master/Store_Database.csv", "r")
        for line in file:
        ...
        for i in range(0, len(self.searchResultsItemNames)):
            ...
            self.txtSearchInput.delete(0, 'end')
    ...
    def ViewMap(self):
        ...
        self.map.title("Map")
        self.map.geometry("800x480")

        pngImage = PhotoImage(file = "D:/Final Year Project/GUI/shopping-organizer-master/Store_Layout.png")
